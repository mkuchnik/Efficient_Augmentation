...
def create_MNIST_CNN_model_cifar10(input_shape=(28, 28),
                           optimizer="adam",
                           n_classes=2):
    import keras
    model = keras.models.Sequential()
...
def create_MNIST_CNN_model_lenet(input_shape=(28, 28),
                                 optimizer="adam",
                                 n_classes=2):
    import keras
    model = keras.models.Sequential()
...
class MNIST_CNN_Extractor(sklearn.base.BaseEstimator,
    ...
    def _create_TF_model(self):
        model = create_MNIST_CNN_model_cifar10(input_shape=self.X_.shape[1:],
