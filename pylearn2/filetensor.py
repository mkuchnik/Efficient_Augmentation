"""
The following code is modified from the Pylearn2 repository.
The original code can be found here:
https://github.com/lisa-lab/pylearn2/blob/master/pylearn2/datasets/filetensor.py

Copyright (c) 2011--2017, Université de Montréal
All rights reserved.
Released under BSD 3-Clause "New" License
...
def write(f, mat):
    ...
    try:
        ...
        #                     mat.dtype))
        TypeError('Invalid ndarray dtype for filetensor format',
                  mat.dtype)
